...
function andromeda_scripts() {
    ...
    wp_enqueue_style('style', get_template_directory_uri() . '/slick/slick.css');
	  wp_enqueue_style('style', get_template_directory_uri() . '/slick/slick-theme.css');
    wp_enqueue_style( 'andromeda-style', get_template_directory_uri() . '/css/main.css' );

	wp_enqueue_script( 'andromeda-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
    wp_enqueue_script( 'larik-jquery', 'https://code.jquery.com/jquery-1.12.4.min.js');
	wp_enqueue_script('slick', get_template_directory_uri() . '/slick/slick.min.js');
	wp_enqueue_script( 'larik-script', get_template_directory_uri() . '/script.js' );
